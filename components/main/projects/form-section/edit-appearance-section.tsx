...
const EditProjectAppearanceSection = ({
  form,
  title,
  user,
}: {
              ...
              <div className="space-y-2 w-full">
                <FormControl>
                  <Select
                    disabled={!user}
                    value={field.value}
                    onValueChange={(v) => v != "" && field.onChange(v)} // i dont know why i should do it like this, but it works based on the github issue lmao
                  >
...
export default EditProjectAppearanceSection;
